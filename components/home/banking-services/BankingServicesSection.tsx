...
import { BankingServicesImage } from ".";
...
const BankingServicesSection = (props: InvestmentSectionProps) => {
    return (
        <section
            className={cn(
...
export default BankingServicesSection;
